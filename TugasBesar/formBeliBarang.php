...
<body>
   ...
   <div class="container">
      <nav class="navbar navbar-dark fixed-top" style="background: #2b2d42;">
                     ...
                     <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Akun<i class="fa-solid fa-user"></i></a>
                           <ul class="dropdown-menu dropdown-menu-dark">
                              ...
                              <li><a class="dropdown-item" href="registerForm.php">Buat Akun</a></li>
         ...
         <h3>Form Beli</h3>
            <input type="alamat" name="alamat" required placeholder="masukkan alamat pengiriman...">
            <input type="hidden" name="id_barang" value="<?php echo $id_barang; ?>">
            <input type="submit" name="submit" value="check out" class="form-btn">
         </form>
      </div>
      </div>
